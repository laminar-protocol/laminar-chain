...
pub use frame_support::{
	...
	traits::{Contains, ContainsLengthBound, Filter, Get, InstanceFilter, KeyOwnerProofSystem, Randomness},
	weights::{
...
parameter_types! {
	pub NativeOrmlTokens: BTreeSet<(Vec<u8>, MultiLocation)> = {
		...
		t.insert(("AUSD".into(), MultiLocation::X2(Junction::Parent, Junction::Parachain { id: 5000 })));
		t
	};
}
