...
impl MarginProtocolLiquidityPools<AccountId> for MockLiquidityPools {
	...
	fn get_swap_rate(_pool_id: Self::LiquidityPoolId, _pair: Self::TradingPair, _is_long: bool) -> Fixed128 {
		unimplemented!()
	}

	fn get_accumulated_swap_rate(_pool_id: Self::LiquidityPoolId, pair: Self::TradingPair, is_long: bool) -> Fixed128 {
