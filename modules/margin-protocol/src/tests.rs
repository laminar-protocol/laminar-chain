...
fn fixed128_from_natural_currency_cent(n: i128) -> Fixed128 {
	Fixed128::from_inner(n * 1_000_000_000_000_000_0)
}
...
fn eur_jpy_long() -> Position<Runtime> {
	Position {
		...
		leveraged_held: Fixed128::saturating_from_integer(100_000),
		leveraged_debits: Fixed128::saturating_from_integer(-14_104_090),
		leveraged_debits_in_usd: fixed128_from_natural_currency_cent(-131_813_93),
		open_accumulated_swap_rate: Fixed128::saturating_from_integer(1),
...
fn eur_jpy_short() -> Position<Runtime> {
	Position {
		...
		leveraged_held: Fixed128::saturating_from_integer(-100_000),
		leveraged_debits: Fixed128::saturating_from_integer(14_175_810),
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			assert_eq!(
				...
				Ok(Fixed128::from_inner(-1073545454545441750827)),
			);
		});
}
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			assert_eq!(
				...
				Ok(Fixed128::from_inner(1470999999999987140172)),
			);
		});
}
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_eq!(
				...
				Ok(Fixed128::from_inner(397454545454545389345))
			);
		});
}
...
fn eur_usd_long_1() -> Position<Runtime> {
	let open_rate =
		Fixed128::saturating_from_integer(1).saturating_add(Fixed128::saturating_from_rational(36_87, 100_000_00));
	Position {
		owner: ALICE,
		pool: MOCK_POOL,
		pair: EUR_USD_PAIR,
...
fn eur_usd_long_2() -> Position<Runtime> {
	let open_rate =
		Fixed128::saturating_from_integer(1).saturating_add(Fixed128::saturating_from_rational(18_43, 100_000_00));
	Position {
		owner: ALICE,
		pool: MOCK_POOL,
		pair: EUR_USD_PAIR,
...
fn eur_usd_short_1() -> Position<Runtime> {
	let open_rate =
		Fixed128::saturating_from_integer(1).saturating_add(Fixed128::saturating_from_rational(10_96, 100_000_00));
	Position {
		owner: ALICE,
		pool: MOCK_POOL,
		pair: EUR_USD_PAIR,
...
fn eur_usd_short_2() -> Position<Runtime> {
	let open_rate =
		Fixed128::saturating_from_integer(1).saturating_add(Fixed128::saturating_from_rational(3_65, 100_000_00));
	Position {
		owner: ALICE,
		pool: MOCK_POOL,
		pair: EUR_USD_PAIR,
		leverage: Leverage::ShortFifty,
		leveraged_held: Fixed128::saturating_from_integer(-200_000),
...
fn accumulated_swap_rate_of_long_position_works() {
	ExtBuilder::default()
		...
		.accumulated_swap_rate(EUR_USD_PAIR, Fixed128::saturating_from_integer(1))
		.build()
		.execute_with(|| {
			assert_eq!(
				MarginProtocol::_accumulated_swap_rate_of_position(&eur_usd_long_1()),
				Ok(Fixed128::from_inner(-44398964610000000000))
			);
		});
}
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			assert_eq!(
				...
				Ok(Fixed128::from_inner(-13127898960000000000))
			);
		});
}
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_eq!(
				...
				Ok(Fixed128::from_inner(-57526863570000000000))
			);
		});
}
...
fn equity_of_trader_works() {
	ExtBuilder::default()
		...
		.build()
		.execute_with(|| {
			<Balances<Runtime>>::insert(ALICE, MOCK_POOL, fixed128_from_natural_currency_cent(120_000_00));
			<Positions<Runtime>>::insert(0, eur_usd_long_1());
			...
			assert_eq!(
				...
				Ok(Fixed128::from_inner(116614700431840000000000))
			);
		});
}
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_eq!(
				...
				// 19.54%
				Ok(Fixed128::from_inner(195340363524869506))
			);
		});
}
...
fn margin_level_without_any_opened_position_is_max() {
	ExtBuilder::default().build().execute_with(|| {
		<Balances<Runtime>>::insert(ALICE, MOCK_POOL, Fixed128::from_inner(1));
		assert_eq!(
			MarginProtocol::margin_level(&ALICE, MOCK_POOL),
...
fn ensure_trader_safe_works() {
	ExtBuilder::default()
		...
		.build()
		.execute_with(|| {
			TraderRiskThreshold::insert(EUR_USD_PAIR, risk_threshold(100, 0));
			...
			assert_eq!(
				MarginProtocol::margin_level(&ALICE, MOCK_POOL),
				Ok(Fixed128::saturating_from_integer(1))
			);
			...
			// 100% > 99%, safe
			TraderRiskThreshold::insert(EUR_USD_PAIR, risk_threshold(99, 0));
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_eq!(
				...
				Ok(Fixed128::from_inner(103385299568160000000000))
			);
		});
}
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_eq!(
				...
				Ok((
					Fixed128::from_inner(881353313244259093),
					Fixed128::from_inner(289479128269976269)
				))
			);
		});
}
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_eq!(
				...
				Ok((
					Fixed128::from_inner(830424770574396509),
					Fixed128::from_inner(830424770574396509)
				))
			);
		});
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_eq!(
				...
				Ok((
					Fixed128::from_inner(881352460750416230),
					Fixed128::from_inner(289478848269696269)
				))
			);
		});
}
...
fn ensure_liquidity_works() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			LiquidityPoolELLThreshold::insert(EUR_USD_PAIR, risk_threshold(100, 0));
...
fn ensure_pool_safe_works() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			// ENP 100% == 100%, unsafe
			LiquidityPoolENPThreshold::insert(EUR_USD_PAIR, risk_threshold(100, 0));
			assert_noop!(
...
fn trader_margin_call_should_work() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_eq!(
				MarginProtocol::margin_level(&ALICE, MOCK_POOL),
				Ok(Fixed128::saturating_from_rational(5, 100))
			);
...
fn trader_become_safe_should_work() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_eq!(
				MarginProtocol::margin_level(&ALICE, MOCK_POOL),
				Ok(Fixed128::saturating_from_rational(4, 100))
			);
			assert_ok!(MarginProtocol::trader_margin_call(Origin::NONE, ALICE, MOCK_POOL));
			assert_noop!(
			...
			assert_eq!(
				MarginProtocol::margin_level(&ALICE, MOCK_POOL),
				Ok(Fixed128::saturating_from_rational(6, 100))
			);
			assert_ok!(MarginProtocol::trader_become_safe(Origin::NONE, ALICE, MOCK_POOL));
		});
}
...
fn trader_stop_out_should_work() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_eq!(
				MarginProtocol::margin_level(&ALICE, MOCK_POOL),
				Ok(Fixed128::saturating_from_rational(3, 100))
			);
...
fn trader_stop_out_close_bigger_loss_position() {
	ExtBuilder::default()
		...
		.build()
		.execute_with(|| {
			TraderRiskThreshold::insert(EUR_USD_PAIR, risk_threshold(70, 60));
			<Balances<Runtime>>::insert(ALICE, MOCK_POOL, fixed128_from_natural_currency_cent(100));
...
fn open_long_position_works() {
	ExtBuilder::default()
		...
		.accumulated_swap_rate(EUR_JPY_PAIR, Fixed128::saturating_from_integer(1))
		.pool_liquidity(MOCK_POOL, balance_from_natural_currency_cent(100_000_00))
		.build()
		.execute_with(|| {
			<Balances<Runtime>>::insert(ALICE, MOCK_POOL, fixed128_from_natural_currency_cent(10_000_00));
			...
			let position = {
				...
				p.leveraged_debits = Fixed128::from_inner(-14104090000000000732600000);
				p.leveraged_debits_in_usd = Fixed128::from_inner(-131813925233644859805488);
				p.margin_held = Fixed128::from_inner(6590696261682242990274);
				p
			};
			let id = 0;
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			let position = {
				...
				// with higher precision level
				p.leveraged_debits = Fixed128::from_inner(14175810000000000585500000);
				p.leveraged_debits_in_usd = Fixed128::from_inner(133734056603773584812414);
				p.margin_held = Fixed128::from_inner(6686702830188679240620);
				p
			};
...
fn open_position_fails_if_leveraged_debits_out_of_bound() {
	ExtBuilder::default()
		...
		.build()
		.execute_with(|| {
			<Balances<Runtime>>::insert(ALICE, MOCK_POOL, Fixed128::max_value());
			assert_noop!(
				MarginProtocol::open_position(
					Origin::signed(ALICE),
					MOCK_POOL,
...
fn open_position_fails_if_would_reach_enp_threshold() {
	ExtBuilder::default()
		...
		.build()
		.execute_with(|| {
			LiquidityPoolENPThreshold::insert(EUR_JPY_PAIR, risk_threshold(10, 5));
			<Balances<Runtime>>::insert(ALICE, MOCK_POOL, fixed128_from_natural_currency_cent(10_000_00));
			assert_noop!(
				MarginProtocol::open_position(
					Origin::signed(ALICE),
...
fn open_position_fails_if_would_reach_ell_threshold() {
	ExtBuilder::default()
		...
		.build()
		.execute_with(|| {
			LiquidityPoolELLThreshold::insert(EUR_JPY_PAIR, risk_threshold(10, 5));
			<Balances<Runtime>>::insert(ALICE, MOCK_POOL, fixed128_from_natural_currency_cent(10_000_00));
			assert_noop!(
				MarginProtocol::open_position(
					Origin::signed(ALICE),
...
fn close_loss_position_works() {
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_eq!(
				MarginProtocol::balances(ALICE, MOCK_POOL),
				Fixed128::from_inner(9415301035390000000000)
			);
...
fn close_loss_position_realizing_part_on_not_enough_equity() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			TraderRiskThreshold::insert(EUR_USD_PAIR, risk_threshold(100, 0));
			<Balances<Runtime>>::insert(ALICE, MOCK_POOL, fixed128_from_natural_currency_cent(1_00));
			let position: Position<Runtime> = Position {
				owner: ALICE,
				pool: MOCK_POOL,
				pair: EUR_USD_PAIR,
...
fn close_loss_position_realizing_nothing_on_negative_equity() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			TraderRiskThreshold::insert(EUR_USD_PAIR, risk_threshold(100, 0));
			<Balances<Runtime>>::insert(ALICE, MOCK_POOL, fixed128_from_natural_currency_cent(2_00));
			let position: Position<Runtime> = Position {
				owner: ALICE,
				pool: MOCK_POOL,
				pair: EUR_USD_PAIR,
			...
			assert_eq!(
				MarginProtocol::balances(&ALICE, MOCK_POOL),
				Fixed128::saturating_from_integer(-88)
			);
		});
}
...
fn close_profit_position_works() {
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_eq!(
				MarginProtocol::balances(ALICE, MOCK_POOL),
				Fixed128::from_inner(10438691023010000000000)
			);
...
fn deposit_works() {
	ExtBuilder::default().alice_balance(1000).build().execute_with(|| {
		...
		assert_eq!(MarginProtocol::balances(&ALICE, MOCK_POOL), Fixed128::from_inner(500));
...
fn withdraw_works() {
	ExtBuilder::default()
		.module_balance(Fixed128::from_inner(1000))
		.build()
		.execute_with(|| {
			<Balances<Runtime>>::insert(ALICE, MOCK_POOL, Fixed128::from_inner(1000));
...
fn withdraw_fails_if_insufficient_free_margin() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_noop!(
				MarginProtocol::withdraw(Origin::signed(ALICE), MOCK_POOL, balance_from_natural_currency_cent(1)),
				Error::<Runtime>::InsufficientFreeMargin
			);
		});
}
...
fn offchain_worker_should_work() {
	...
	ext.execute_with(|| {
		TraderRiskThreshold::insert(EUR_USD_PAIR, risk_threshold(3, 1));
		LiquidityPoolENPThreshold::insert(EUR_USD_PAIR, risk_threshold(10, 2));
		LiquidityPoolELLThreshold::insert(EUR_USD_PAIR, risk_threshold(50, 20));
		<Balances<Runtime>>::insert(&ALICE, MOCK_POOL, fixed128_from_natural_currency_cent(10_00));
		assert_eq!(
		...
		assert_eq!(
			MarginProtocol::margin_level(&ALICE, MOCK_POOL).ok().unwrap(),
			Fixed128::saturating_from_rational(5, 100) // 5%
		);
		...
		assert_eq!(
			MarginProtocol::margin_level(&ALICE, MOCK_POOL).ok().unwrap(),
			Fixed128::saturating_from_rational(2, 100) // 2%
		);
		...
		assert_eq!(
			MarginProtocol::margin_level(&ALICE, MOCK_POOL).ok().unwrap(),
			Fixed128::saturating_from_rational(1, 100) // 1%
		);
...
fn liquidity_pool_manager_get_required_deposit_works() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			LiquidityPoolENPThreshold::insert(EUR_USD_PAIR, risk_threshold(100, 0));
			LiquidityPoolELLThreshold::insert(EUR_USD_PAIR, risk_threshold(90, 0));
			let position: Position<Runtime> = Position {
				owner: ALICE,
				pool: MOCK_POOL,
				pair: EUR_USD_PAIR,
			...
			LiquidityPoolENPThreshold::insert(EUR_USD_PAIR, risk_threshold(80, 0));
			assert_eq!(
				MarginProtocol::pool_required_deposit(MOCK_POOL),
...
fn trader_open_positions_limit() {
	ExtBuilder::default()
		...
		.build()
		.execute_with(|| {
			LiquidityPoolENPThreshold::insert(EUR_USD_PAIR, risk_threshold(90, 0));
			LiquidityPoolELLThreshold::insert(EUR_USD_PAIR, risk_threshold(100, 0));
			// give alice $100
			<Balances<Runtime>>::insert(&ALICE, MOCK_POOL, fixed128_from_natural_currency_cent(100_00));
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_eq!(
				MarginProtocol::_enp_and_ell(MOCK_POOL, Action::OpenPosition(eur_usd_long_1())),
				Ok((
					Fixed128::from_inner(89124088565673727),
					Fixed128::from_inner(89124088565673727)
				))
			);
			...
			LiquidityPoolELLThreshold::insert(EUR_USD_PAIR, risk_threshold(5, 5));
			assert_ok!(MarginProtocol::ensure_can_enable_trading_pair(MOCK_POOL, EUR_USD_PAIR));
		});
}
...
fn open_position_check_trader_works() {
	ExtBuilder::default()
		...
		.build()
		.execute_with(|| {
			TraderRiskThreshold::insert(EUR_USD_PAIR, risk_threshold(3, 5));
			TraderRiskThreshold::insert(EUR_JPY_PAIR, risk_threshold(5, 3));
			TraderRiskThreshold::insert(JPY_USD_PAIR, risk_threshold(6, 7));
